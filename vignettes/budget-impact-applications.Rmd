...
budget_wout1_new <- 0
budget_wout1 <- budget_wout1_new + budget_wout1_soc
```
...
budget_with1 <- budget_with1_new + budget_with1_soc
```

Finally, we derive the budget impact as the difference in costs.
...
budget_with2 <- budget_with2_new + budget_with2_soc
```

Finally again, we derive budget impact as the difference.
...
| | Standard of Care | `r total(budget_with1_soc)` | `r total(budget_with2_soc)` | `r total(budget_with3_soc)`  | `r total(budget_with4_soc)`  |
...
| Budget impact || ||  |  |
| | Standard of Care | `r total(bi1_soc)` | `r total(bi2_soc)` | `r total(bi3_soc)` | `r total(bi4_soc)`  |
| | New intervention | `r total(bi1_new)` | `r total(bi2_new)` | `r total(bi3_new)` | `r total(bi4_new)`  |
